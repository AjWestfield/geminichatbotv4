...
- Name: MCP Server Integration >> should add MCP server manually
- Location: /Users/andersonwestfield/Desktop/geminichatbotv2/tests/e2e/mcp-servers.spec.ts:28:7
...
Call log:
  - waiting for locator('[role="dialog"]') to be visible
    ...
    at /Users/andersonwestfield/Desktop/geminichatbotv2/tests/e2e/mcp-servers.spec.ts:31:16
```
